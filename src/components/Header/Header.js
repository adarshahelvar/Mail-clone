...
const useStyles = makeStyles((theme) => ({        // taken from material UI
  large: {
...
const Header = () => {
  ...
  const { currentUser, setDrawerOpen, drawerOpen } = useLocalContect();     // drawopen is side bar open and close

  const [anchorEl, setAnchorEl] = React.useState(null);      // materail UI
          ...
          >
            <div className="home__popoverContainer">
              ...
              <div className="home__popover__btm">
                ...
                <Button variant="outlined" className="home__signOut" onClick={signout} > Sign Out</Button>
